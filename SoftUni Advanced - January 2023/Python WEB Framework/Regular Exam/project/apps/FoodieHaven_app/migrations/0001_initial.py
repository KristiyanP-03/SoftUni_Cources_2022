    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(unique=True, validators=[apps.FoodieHaven_app.models.no_spaces, apps.FoodieHaven_app.models.username_length], verbose_name='Username')),
